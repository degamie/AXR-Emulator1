...
public class SampleRendererController{
   ...
   @GetMapping("/saveAll/{Renderer}")
    ...
    @PostMappping("/findAll/{ViewPortSize}")//Retrieving  ViewPortSize in Server

    public void setAllByyViewPortSize(@RequestParam "ViewPortSize" float ViewPortSize,@RequestBody SampleRenderer sampleRenderer){
       return samplerenderService.setsetAllByyViewPortSize
    }
